...
const InstitutTraducteurBreadcrumb = ({ title, SubTitle }) => {
            ...
            <section className="hidden md:block">
                <div className="container">
                    <div className="my-6 rounded-lg border border-default-200 bg-white dark:bg-default-50">
                        ...
                        {window.location.pathname !== "/institut/dashboard" && <>
...
export default InstitutTraducteurBreadcrumb;
