...
const InstitutTraducteurListeSuperviseur = () => {
    ...
    return (
        <div style={{ background: "#f0f2f5", minHeight: "100vh" }}>
            <InstitutTraducteurBreadcrumb title={t("institutMenu.manage_admins")} SubTitle={institut?.name || "Institut"} />
                                ...
                                <Card>
                                    ...
                                    >
                                        ...
                                        <Button type="primary" icon={<PlusOutlined />} onClick={showAddSupervisorModal}>
                                            {t("institutSuperviseur.addNewSupervisor")}
                                        </Button>
                                    </div>
...
export default InstitutTraducteurListeSuperviseur
