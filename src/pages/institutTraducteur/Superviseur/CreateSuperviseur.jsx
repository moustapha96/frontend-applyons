...
const InstitutTraducteurCreateSuperviseur = () => {
    ...
    return (
        <div style={{ background: "#f0f2f5", minHeight: "100vh" }}>
            <InstitutTraducteurBreadcrumb title={t("institutMenu.documentTool")} SubTitle={institut?.name} />
...
export default InstitutTraducteurCreateSuperviseur
