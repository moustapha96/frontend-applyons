...
const InstitutProfil = () => {
    const { saveSession, superviseur, role, setInstitut, institut, session, saveProfilImage, profileImage } =
        useAuthContext()
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8 transition-all duration-300 hover:shadow-lg">
                    ...
                    <div className="pt-20 px-8 pb-8">
                        ...
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            <Option value="Ambassade">{t('inscriptionPage.embassy')}</Option>
                            <Option value="Université">{t('inscriptionPage.university')}</Option>
                            <Option value="Collège">{t('inscriptionPage.college')}</Option>
                            <Option value="Lycée">{t('inscriptionPage.highSchool')}</Option> */}
                                        ...
                                        t('inscriptionPage.bank') : institut.type == "Ambassade" ?
                                            t('inscriptionPage.embassy') : institut.type == "Université" ?
                                                t('inscriptionPage.university') : institut.type == "Collège" ?
                                                    t('inscriptionPage.college') : t('inscriptionPage.highSchool')}
                                name="type"
                                editing={false}
                                onChange={handleInputChange}
