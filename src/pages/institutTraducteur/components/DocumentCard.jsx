...
import { FileText, Calendar, Award, CheckCircle, Building, Mail, Phone, MapPin, User, Loader2, Minus, Plus } from "lucide-react";
            ...
            <section>
                ...
                <div className="">
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        {loading && <span className="flex items-center justify-center" >  <Loader2 className="animate-spin h-8 w-8 "></Loader2>  </span>}
                        {fichier && !loading && (
                            <>
