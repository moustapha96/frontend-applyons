...
const VerificationFormDemandeur = ({ control, errors, onSubmit, reset, activeSubscription, loading }) => {
    ...
    return (
        <form onSubmit={onSubmit} className="space-y-6">
            ...
            <div>
                <label htmlFor="codeAdn" className="block text-sm font-medium text-gray-700">{"Code ADN Demandeur"}</label>
                <Controller
                    name="codeAdn"
                    control={control}
                    render={({ field }) => (
...
export default VerificationFormDemandeur;
