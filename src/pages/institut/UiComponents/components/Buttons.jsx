  ...
  return (
    <ComponentContainerCard title="Ghost Buttons">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Link
          to=""
          className="inline-block rounded-md px-6 py-2 text-center text-base text-blue-600 transition-all hover:bg-blueLogo/20"
        >
          Blue
        </Link>
        <Link
  ...
  return (
    <ComponentContainerCard title="Ghost Rounded Buttons">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Link
          to=""
          className="inline-block rounded-full px-6 py-2 text-center text-base text-blue-600 transition-all hover:bg-blueLogo/20"
        >
          Blue
        </Link>
        <Link
  ...
  return (
    <ComponentContainerCard title="Button Icons">
      <div className="flex flex-wrap items-center gap-2">
        <Link
          to=""
          className="inline-flex size-10 items-center justify-center rounded-md bg-blueLogo text-white transition-all hover:bg-blue-600"
        >
