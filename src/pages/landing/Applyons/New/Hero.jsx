...
const Hero = () => {
    ...
    const heroContent = pageContent?.landing?.[lang]?.hero;
    const title = heroContent?.title ?? t('applyons.hero.title');
    const subtitle = heroContent?.subtitle ?? t('applyons.hero.subtitle');
    const cta = heroContent?.cta ?? t('applyons.hero.cta');
