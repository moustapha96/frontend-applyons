                ...
                <div className="bg-gray-50 dark:bg-slate-900 pb-16 pt-24">
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                        <div className="max-w-3xl mx-auto">
                            ...
                            >
                                <section>
                                    <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">{t("privacy.introduction.title")}</h2>
                                    <p className="text-gray-600 dark:text-gray-300">{t("privacy.introduction.description")}</p>
                                </section>
                                <section>
                                    <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">{t("privacy.dataCollection.title")}</h2>
                                    <p className="text-gray-600 dark:text-gray-300 mb-4">{t("privacy.dataCollection.description")}</p>
                                ...
                                <section>
                                    <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">{t("privacy.dataUse.title")}</h2>
                                    <p className="text-gray-600 dark:text-gray-300 mb-4">{t("privacy.dataUse.description")}</p>
                                    <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                                ...
                                <section>
                                    <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">{t("privacy.dataSecurity.title")}</h2>
                                    <p className="text-gray-600 dark:text-gray-300 mb-4">{t("privacy.dataSecurity.description")}</p>
                                    <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                                ...
                                <section>
                                    <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">{t("privacy.userRights.title")}</h2>
                                    <p className="text-gray-600 dark:text-gray-300 mb-4">{t("privacy.userRights.description")}</p>
                                    <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                                ...
                                <section>
                                    <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">{t("privacy.cookies.title")}</h2>
                                    <p className="text-gray-600 dark:text-gray-300 mb-4">{t("privacy.cookies.description")}</p>
                                    <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                                ...
                                <section>
                                    <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">{t("privacy.contact.title")}</h2>
