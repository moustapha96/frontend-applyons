...
const Statistics = ({ demandePartage, documentPartage }) => {
      ...
      {/* <div className="rounded-md border border-default-200 bg-white dark:bg-default-50">
        <div className="p-5">
          <div>
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-default-600">
                {t("demandeur.demandesAccepteCount")}
              </span>
              <span className="text-teal-500">
                <LuTrendingUp className="me-1 inline size-4" />
                {demandesAccepteCount}%
      ...
      <div className="rounded-md border border-default-200 bg-white dark:bg-default-50">
        <div className="p-5">
          <div>
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-default-600">
                {t("demandeur.demandesRejeteCount")}
              </span>
              <span className="text-teal-500">
                <LuTrendingUp className="me-1 inline size-4" />
                {demandesRejeteCount}%
