...
import { updatePaymentIntentDemandeur, updatePayPalPaymentDemandeur } from "../../../services/paymentService";
import { useAuthContext } from "../../../context/useAuthContext";

const DemandeurSuccessPage = () => {
    ...
    useEffect(() => {
        //console.log(paymentIntent, paymentIntentClientSecret, redirectStatus, paypalOrderId)
        const updatePaymentIntent = async () => {
            if (paymentIntent) {
                // Stripe payment
                const res = await updatePaymentIntentDemandeur(paymentIntent, redirectStatus, demandeur.id);
                //console.log(res);
            } else if (paypalOrderId) {
                // PayPal payment
                // You might need to create a new function to handle PayPal payment updates
                const res = await updatePayPalPaymentDemandeur(paypalOrderId, demandeur.id);
                //console.log(res);
            }
        }
        updatePaymentIntent();
...
export default DemandeurSuccessPage;